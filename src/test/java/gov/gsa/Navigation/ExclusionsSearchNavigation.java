...
public class ExclusionsSearchNavigation extends ObjectView {

    public static void gotoObjectView(String wd_SearchTerm) throws InterruptedException {
        ...
        new Select(Base.driver.findElement(By.id("filter"))).selectByVisibleText("Exclusions");
